...
const candidateWithSynonymPredictions: Predictions = {
  ...predictions,
  parentPredictions: [],
};

const candidateWithChildPredictions: Predictions = {
  ...predictions,
  synonymPredictions: [],
};
...
describe("PredictionCard", () => {
  ...
  it("should show the correct total score", async () => {
    ...
    const synonymScore = predictions.synonymPredictions[0].score;
    const childScore = predictions.parentPredictions[0].score;
  ...
  it("should show the correct total score when there are only synonym predictions", async () => {
    ...
    const wrapper = shallowMount(PredictionCard, {
      props: {
        predictions: candidateWithSynonymPredictions,
        currentNodeId: nodeA.id,
      },
    });
  ...
  it("should show the correct total score when there are only child predictions", async () => {
    ...
    const wrapper = shallowMount(PredictionCard, {
      props: {
        predictions: candidateWithChildPredictions,
        currentNodeId: nodeB.id,
      },
    });
